...
ALTER TABLE PROVEEDORES 
	ADD CONSTRAINT CNN_UN_PRV_NOMBRE UNIQUE (NOMBRE);
...
ALTER TABLE COMPRAS_PROVEEDORES 
	ADD CONSTRAINT FK_COMPRAS_ID_PROVEEDOR 
...
CREATE TABLE  CHEQUES(
	...
	ID_CHEQUERA 	NUMBER(19) 							NOT NULL, 
	MONTO 			NUMBER(18,2) 						NOT NULL, 
	SOBRE_SALDO 	NUMBER(1) 		DEFAULT 0 			NOT NULL, 
...
ALTER TABLE CHEQUES 
	ADD CONSTRAINT FK_CHEQUES_ID_COMPRA 
	FOREIGN KEY (ID_COMPRA) 
	REFERENCES COMPRAS_PROVEEDORES (ID_COMPRA);

ALTER TABLE CHEQUES 
	ADD CONSTRAINT FK_CHEQUES_ID_CHEQUERA 
	FOREIGN KEY (ID_CHEQUERA) 
	REFERENCES CHEQUERAS (ID_CHEQUERA);

 ALTER TABLE CHEQUES 
    ADD CONSTRAINT CK_TBL_CH_SALDO 
    CHECK (SOBRE_SALDO BETWEEN 0 AND 1);

CREATE SEQUENCE SEQ_CHEQUE_ID
      START WITH 20
      INCREMENT BY 1;
...
/*
 * 	ALTER TABLE PARA LA INFORMACIÓN DE LAS PERSONAS AGREGANDO EL CAMPO, PARA LOS CONTACTOS DE LOS PROVEEORES
 * */

ALTER TABLE INFO_PERSONAS 
	ADD (  ID_PROVEEDOR  NUMBER(19)  	NULL);


ALTER TABLE INFO_PERSONAS 
	ADD CONSTRAINT FK_INFO_PERSONAS_ID_PROV 
	FOREIGN KEY (ID_PROVEEDOR) 
	REFERENCES PROVEEDORES (ID_PROVEEDOR);
  
	
	
ALTER TABLE CHEQUERAS ADD (CHEQUES_EMITIDOS NUMBER(20) DEFAULT 0);	

ALTER TABLE CHEQUES ADD (NO_CHEQUE NUMBER(20));

/*
 * FECHA: ULTIMOS CAMBIOS SUBIDOS 27/12/2014
 * */
...
ALTER TABLE PROVEEDORES
	DROP COLUMN REG_CREACION;
  
ALTER TABLE PROVEEDORES
	DROP COLUMN REG_ULT_MODIFICACION;
  
ALTER TABLE PROVEEDORES 
	ADD ( ADDED_BY 		  	NUMBER(19) 							NULL, 
          UPDATED_BY 		NUMBER(19) 							NULL, 
          ADD_DATE 		  	TIMESTAMP 		DEFAULT SYSDATE		NOT NULL, 
          UPDATE_DATE 		TIMESTAMP 							NULL, 
          VERSION 		  	NUMBER(19) 							NULL);	
...
/*
 * FECHA: ULTIMOS CAMBIOS SUBIDOS 01/01/2015
 * */
ALTER TABLE PROVEEDORES ADD (MONTO  NUMBER(18,2)    DEFAULT 0   NOT NULL);


/*
 * 	COMENTARIOS DE LAS COMPRAS
 * */
CREATE TABLE COMPRAS_PRV_COMENTARIOS(
...
CREATE SEQUENCE SEQ_COMPRA_COMENT
      START WITH 20
      INCREMENT BY 1;
      
ALTER TABLE COMPRAS_PRV_COMENTARIOS 
	ADD CONSTRAINT FK_COMENT_COMPRA 
	FOREIGN KEY (ID_COMPRA) 
	REFERENCES COMPRAS_PROVEEDORES (ID_COMPRA);
	
ALTER TABLE PROVEEDORES ADD (SALDO  NUMBER(18,2)	DEFAULT 0 		NOT NULL);
...
CREATE TABLE DOCUMENTOS_PERSONA(
  ...
  ADDED_BY 				  NUMBER(19) 						          NULL, 
	...
	UPDATE_DATE 	    TIMESTAMP 							        NULL, 
	VERSION 		      NUMBER(19) 							        NULL,
  PRIMARY KEY (ID_DOC_PERSONA)
);

CREATE SEQUENCE SEQ_DOC_PERSONA 
      START WITH 20
      INCREMENT BY 1;
      
ALTER TABLE DOCUMENTOS_PERSONA 
    ADD CONSTRAINT FK_DOC_PERS_ID_PERS 
    FOREIGN KEY (ID_PERSONA) 
    REFERENCES INFO_PERSONAS (ID_PERSONA);
    
ALTER TABLE DOCUMENTOS_PERSONA 
    ADD CONSTRAINT FK_DOC_PERS_ID_DOC
    FOREIGN KEY (ID_DOCUMENTO) 
    REFERENCES CATG_DOCUMENTOS (ID_DOCUMENTO);