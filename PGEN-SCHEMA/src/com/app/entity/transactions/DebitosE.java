...
/**
 * Entity implementation class for Entity: DebitosE
 *
 */
@Entity
@Table(name = "DEBITOS")
@SequenceGenerator(name = "SEQ_DEBITOS", sequenceName = "SEQ_DEBITOS", allocationSize = 1, initialValue = 1)
public class DebitosE implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_DEBITOS")
	private long id;
